...
public class CarController : MonoBehaviour 
{
	...
	public float maxBrakeTorque = 2500;
	public float maxTurnAngle = 40;
	public float maxTorque = 3500;
	public float decelerationTorque = 2500;
	public Vector3 centerOfMassAdjustment = new Vector3(0f,0f,0f);
	public float spoilerRatio = 0.1f;
	public float handbrakeForwardSlip = 0.001f;
	public float handbrakeSidewaysSlip = 0.001f;
	public float breakingDistance = 20f;
